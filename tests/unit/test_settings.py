...
def _make_settings(**env_overrides):
    ...
    clear_keys = [
        ...
        "LIVENESS_DEVICE_ID",
        "LIVENESS_MODEL_DIR",
        "LIVENESS_DETECTOR_PATH",
        "LIVENESS_ON_ENROLLMENT",
        "LIVENESS_ON_RECOGNITION",
        "USE_HYBRID_RECOGNITION",
        "HYBRID_MODE",
        "INSIGHTFACE_MODEL",
        ...
        "INSIGHTFACE_HIGH_CONFIDENCE",
        "INSIGHTFACE_MEDIUM_CONFIDENCE",
        "AUTO_CAPTURE_ENABLED",
        "AUTO_CAPTURE_CONFIDENCE_THRESHOLD",
        "AUTO_CAPTURE_MAX_VERIFIED_PHOTOS",
        "WEBCAM_ENABLED",
        "WEBCAM_DEVICE_ID",
        "WEBCAM_FPS",
        "WEBCAM_SUCCESS_COOLDOWN_SECONDS",
        "WEBCAM_API_URL",
        "MULTIFACE_ENABLED",
    ...
    env = dict(os.environ.items())  # snapshot
    for k in clear_keys:
        env.pop(k, None)
...
class TestSettingsProperties:
    ...
    def test_database_url(self):
        ...
        assert s.database_url == ("postgresql+asyncpg://myuser:mypass@localhost:5432/testdb")
